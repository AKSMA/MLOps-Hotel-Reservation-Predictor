...
class DataIngestion:
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.info(f'CSV downloaded to {RAW_FILE_PATH}')

        except Exception as e:
            logger.error(f'Error in downloading CSV from GCP: {e}')
    ...
    def split_data(self):
        try:
            ...
            logger.error('Error while splitiing the data')
            raise CustomException('Failed to split data into training and testing set',e)
